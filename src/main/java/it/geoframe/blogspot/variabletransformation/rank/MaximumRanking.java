...
public class MaximumRanking extends Ranking{
	...
	public LinkedHashMap<Double,Double> rank(List<Double> sortedValues){
		...
		for(double value : valuesOccurrences.keySet()) {
			...
			valuesRank.put(value, (double)(super.valuesOccurrences.get(value)+tmp));
	...
	public static void main(String[] args) {
		...
		Ranking fractionalRanking = new MaximumRanking();
