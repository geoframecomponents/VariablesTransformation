...
/**
 * Test the {@link TestInverseNormaScore} module.
 * 
 * 
 * @author Niccolo' Tubini
 */
public class TestInverseNormalScoreTemperature {
	...
	public void Test() throws Exception {
		...
		readerNS.file = "resources/normal_score_temperature.csv";
		...
		ins.minimumFixedValue = -30.0;
		ins.rankingMethod = "average";

		ins.run();
		
		OmsTimeSeriesWriter writer = new OmsTimeSeriesWriter();
		writer.file = "resources/inverse_normal_score_temperature.csv";
